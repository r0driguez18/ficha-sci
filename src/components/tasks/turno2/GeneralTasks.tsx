  ...
  return (
    <div className="space-y-2">
      ...
      <div className="flex items-start space-x-2">
        ...
        />
        <Label htmlFor="servicos2" className="cursor-pointer">Verificar Serviços Vinti4/BCADirecto/Replicação/Servidor MIA</Label>
      </div>
      ...
      <div className="flex items-start space-x-2">
        ...
        />
        <Label htmlFor="verificarReportes" className="cursor-pointer">Verificar Envio Enviar Reportes (INPS, Visto USA, BCV, IMPC)</Label>
      </div>
      ...
      <div className="flex items-start space-x-2">
        ...
        />
        <Label htmlFor="processarTef2" className="cursor-pointer">Processar Ficheiros TEF – RTR/RCT/ERR</Label>
      </div>
      ...
      <div className="border rounded-md p-3 bg-gray-50 dark:bg-gray-800">
        <h4 className="font-medium mb-2">Ficheiros:</h4>
        <div className="ml-4 space-y-2">
          <div className="flex items-start space-x-2">
            <Checkbox 
              id="enviarEci"
      ...
      <div className="flex items-start space-x-2">
        <Checkbox 
          id="confirmarSisp"
          checked={tasks.confirmarSisp}
          onCheckedChange={(checked) => onTaskChange('confirmarSisp', !!checked)}
        />
        <Label htmlFor="confirmarSisp" className="cursor-pointer">Confirmar Atualização Ficheiros Enviados à SISP (ECI * ENV/IMA)</Label>
      </div>
      ...
      <div className="flex items-start space-x-2">
        ...
        />
        <Label htmlFor="verificarPendentes" className="cursor-pointer">Verificar Pendentes dos Balções abertos</Label>
      </div>
      ...
      <div className="flex items-start space-x-2">
        ...
        />
        <Label htmlFor="validarSaco" className="cursor-pointer">Validar Contas Saco – Percurso 1935</Label>
      </div>
      ...
      <div className="flex items-start space-x-2">
        ...
        />
        <Label htmlFor="fecharBalcoes" className="cursor-pointer">Fechar os Balcões Centrais</Label>
      </div>
    </div>
  );
};
