        ...
        <Label htmlFor="verificarRecepcaoSisp" className="cursor-pointer text-black">
          ...
          <span className="inline-flex items-center ml-2 space-x-4">
            <span className="flex items-center">
              ...
              />
              <Label htmlFor="verificarAsc" className="cursor-pointer text-black ml-1">ASC</Label>
            </span>
            <span className="flex items-center">
              <Checkbox 
                id="verificarCsv"
              ...
              />
              <Label htmlFor="verificarCsv" className="cursor-pointer text-black ml-1">CSV</Label>
            </span>
            <span className="flex items-center">
              <Checkbox 
                id="verificarEci"
              ...
              />
              <Label htmlFor="verificarEci" className="cursor-pointer text-black ml-1">ECI</Label>
            </span>
          </span>
        </Label>
      </div>
